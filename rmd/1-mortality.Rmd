...
res$lognoaa <- regfun(dff$zlnoaa, dff$mortality_rate, trigs, "logNO")
```
...
res$lograin <- regfun(dff$zlrain, dff$mortality_rate, trigs, "logRN")
```
...
res$logmodis <- regfun(dff$zlmodis, dff$mortality_rate, trigs, "logMD")
```
