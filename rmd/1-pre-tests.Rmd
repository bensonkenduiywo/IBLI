...
r_kmn <- kmeans(df_w[,-1], centers = 4, iter.max = 500, nstart = 1, algorithm="Lloyd")
...
data2 <- merge(data2, temp, by=c("SUBLOCATION", "season", "year"))
...
#Predict moratlity with defined zones
