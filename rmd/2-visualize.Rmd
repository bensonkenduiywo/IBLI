...
trig_plots <- function(models, label){
  ...
  plot(mqs10.3~r2, data=d, pch=20, col="black", ylab="RIB", xlab = expression(R^2), ylim=c(min(d$mqs10.3), max(d$mqs17.6)+0.1), main=label, cex=0.9, cex.main=1.2, cex.lab=1.2) #yaxt="none"
