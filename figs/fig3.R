...
boxplot(r2~model, data=d, ylab = expression(R^2), xlab="", las=1, main="(a)", cex.axis=.8)
title(xlab="Model", line=2)
boxplot(RIB~model, data=d, xlab="", las=1, main="(b)", cex.axis=.8)
title(xlab="Model", line=2)

boxplot(r2~group, data=d, ylab = expression(R^2), xlab="", las=1, main="(c)", cex.axis=.8)
title(xlab="Predictor", line=2)
boxplot(RIB~group, data=d, xlab="", las=1, main="(d)", cex.axis=.8)
title(xlab="Predictor", line=2)
dev.off()
